...
if [$today == $last_day];
then
ssmtp asharma@snapsystems.in adubey@snapsystems.in vshinde@snapsystems.in ajain@snapsystems.in nmarkam@snapsystems.in < /home/ss4/Documents/Ashwini_folder/ShellScripting/Automate/message.txt;
fi;;
"Feb") 
#echo "This is Feb";
